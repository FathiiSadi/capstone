<x-layout title="Register">
    <section class="login-page">
        <div class="card login-card">
            ...
            <x-forms.form method="POST" action="/main/auth/register" enctype="multipart/form-data" autocomplete="on">
                <div class="mb-3">
                ...
                <div class="mb-3 d-flex justify-content-between align-items-center">
                    <div>
                        <a href="/main/auth/login" class="small text-muted">Already have an account?</a>
                    </div>
