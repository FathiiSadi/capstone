...
<head>
    ...
    <style>
        .about {
            /* Replace SCSS variables with CSS values */
        ...
        :root {
            ...
            --circleShadow: inset 5px 20px 40px rgba(var(--bg-02), 0.25),
                inset 5px 0px 5px rgba(var(--bg-03), 0.3),
                inset 5px 5px 20px rgba(var(--bg-03), 0.25),
                2px 2px 5px rgba(white, 0.2);
        }

        /* Replace SCSS mixins with plain CSS media queries */
        @media screen and (max-width: 799px) {}

        @media screen and (max-height: 660px) {
            /* Add styles for short screens here */
        }
            ...
            .container {
                ...
                .text {
                    ...
                    article {
                        ...
                        button {
                            ...
                            border-radius: 50px;
                            cursor: pointer;
                            box-shadow: 0px 15px 20px rgba(var(--bg-02), 0.5);
                            z-index: 3;
                            color: var(--bg-01);
                            ...
                            &:hover {
                                box-shadow: 0px 10px 10px -10px rgba(var(--bg-02), 0.5);
                ...
                .circle {
                    ...
                    &:before {
                        ...
                        width: 800px;
                        height: 800px;
                        background-color: rgba(var(--bg-02), 0.2);
                        border-radius: 100%;
                        top: 50%;
                        left: 50%;
                        transform: translate(-50%, -50%);
                ...
                .one {
                    .content {
                        ...
                        &:before {
                            ...
                            width: 600px;
                            height: 600px;
                            background-color: rgba(var(--bg-02), 0.3);
                            border-radius: 100%;
                            box-shadow: var(--circleShadow);
        ...
        <div class="container">
            ...
            <div class="text">
                <article>
                    ...
                    <button onclick="location.href='/'">i dare!</button>
                </article>
            </div>
